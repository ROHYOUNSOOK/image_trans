...
IMPORTANT: If text on the same visual line has different font colors (e.g. part white, part yellow), treat each differently-colored part as a SEPARATE segment with its own tight bounding box — do not merge them into one box.
