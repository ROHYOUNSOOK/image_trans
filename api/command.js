...
- 모든 텍스트(글자, 외곽선, 그림자 포함)는 이미지 가장자리(상하좌우)에서 안쪽으로 최소 3% 여백 안에 완전히 들어가야 한다. 만약 원래 텍스트 크기로는 이 여백을 넘어선다면, 다른 모든 스타일 효과는 그대로 유지한 채 글자 크기만 비례적으로 줄여서 여백 안에 맞춰라. 가장자리에 닿거나 잘리게 두지 마라.
