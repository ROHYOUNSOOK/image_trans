...
- 결과 이미지에는 지정된 새 글자만 있어야 한다. 원본 언어(예: 한글)의 글자나 그 흔적이 조금이라도 남아 있으면 안 된다. 원본 글자를 완전히 덮어 새 글자로 대체하라. 옛 글자와 새 글자가 겹쳐 보이면 안 된다.
- 글자를 가로나 세로로 늘리거나 눌러서 왜곡하지 마라. 원본의 자연스러운 글자 비율과 자간을 유지하라.
- 말풍선·아이콘·배지 같은 작은 그래픽 요소 안의 글자도 원본과 같은 위치·크기로 또렷하게 렌더링하라. 뭉개거나 두 글자가 겹치게 두지 마라.
